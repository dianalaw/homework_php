...
<body>
    ...
    /*$result = $arr[0] * $arr[1] + $arr[2] * $arr[3];
     ...
     for ($i = 0; $i < count($arr); $i++) {
         $result += $arr[$i] * (!isset($arr[$i+1]) ? 1 : $arr[$i+1]);
     }
     echo $result;
     ...
     echo '<div style ="width: 250px; height:250px; margin:25px; background-color: '. $result . '" > </div>';
     ...
     //Task 40
     echo '<p><strong> Task 40 </strong></p>';
...
него. Функция должна возвращать true или false.*/
     ...
     var_dump(checkPhone('+375 26 3678965--'));
     echo '<hr />';


     //Task 41
    echo '<p><strong> Task 41 </strong></p>';
